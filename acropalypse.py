...
class Acropalypse():
    ...
    def reconstruct_image(self, cropped_image_file, img_width, img_heigth, rgb_alpha):
        ...
        prefix = b"\x00" + (prefix_lenght).to_bytes(2, "little") + (prefix_lenght ^ 0xffff).to_bytes(2,
                                                                                                     "little") + b"\x00" * prefix_lenght
        ...
        for i in range(len(idat)):
            ...
            try:
                ...
                if d.eof and d.unused_data in [b"",
                                               b"\x00"]:  # there might be a null byte if we added too many padding bits
